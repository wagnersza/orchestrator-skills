<!--
Vendored from https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/prompting-claude-opus-5
Fetched 2026-07-29. Refresh manually when the guide changes.
Used by: opus-5 (anthropic) and gpt-5.6 "sol" (openai) — sol follows this guide.
