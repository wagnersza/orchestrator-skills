...
| 13| automation-repoint | **unsupported** — nothing is created, so nothing is repointed. A transition changes nothing else about the flow, and the report says the repoint is unavailable on this tool |
