...
| [#178](https://github.com/wagnersza/orchestrator-skills/issues/178) — the queue tick spawns the worker, under two gates and two roofs | [`178-queue-tick-spawns-the-worker.html`](178-queue-tick-spawns-the-worker.html) | `00564be` | 8, of which 4 `Strong` |
| [#288](https://github.com/wagnersza/orchestrator-skills/issues/288) — the start gate reads a story by its card, and a child by its label | [`288-start-gate-story-card.html`](288-start-gate-story-card.html) | `50ae87d` | 4, of which 2 `Strong` |
